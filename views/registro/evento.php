<div class="evento">
    ...
    <div class="evento__informacion">
        ...
        <button type="button" data-id="<?php echo $evento->id; ?>" class="evento__agregar <?php echo ($evento->categoria_id === '2') ? 'evento__agregar--whorshops' : '';?>" <?php echo ($evento->disponibles === "0") ? 'disabled' : ''; ?>>
