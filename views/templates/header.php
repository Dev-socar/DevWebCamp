<header class="header">
    <div class="header__contenedor">
        <nav class="header__navegacion">
            <?php if(is_Auth()) { ?>
                <a target="_blank" href="<?php echo is_Admin() ? '/admin/dashboard' : '/finalizar-registro'; ?>" class="header__enlace">Administrar</a>
        ...
        <div class="header__contenido">
            ...
            <p class="header__texto">Noviembre 5-6 - 2023</p>
